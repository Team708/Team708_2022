...
public class Climb extends SequentialCommandGroup{
    ...
    public Climb(DriveSubsystem m_driveSubsystem, Climber m_climber){
        addCommands(
            ...
            new ClimberArmUp(m_driveSubsystem, m_climber, -33000, -2),  //-35000, -2    //0 uses value for fully extended arm
            new WaitCommand(.2),        //springs do your thing                                  
            ...
            new ClimberArmDown(m_driveSubsystem, m_climber, 8000, .8), //8000 .8 <=works           //delta off current position 
            new WaitCommand(.5),
